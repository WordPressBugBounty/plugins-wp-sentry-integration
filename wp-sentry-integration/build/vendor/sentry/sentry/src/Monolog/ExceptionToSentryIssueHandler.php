 ...
 */
class ExceptionToSentryIssueHandler extends \Monolog\Handler\AbstractHandler
{
    /**
     * @var HubInterface
     */
    ...
    public function handle($record) : bool
    {
        ...
        $this->hub->withScope(function (\Sentry\State\Scope $scope) use($record, $exception) : void {
