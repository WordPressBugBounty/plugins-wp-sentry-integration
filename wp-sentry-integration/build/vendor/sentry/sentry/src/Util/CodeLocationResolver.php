...
final class CodeLocationResolver
{
     ...
     * @phpstan-param list<StacktraceFrame> $backtrace
     */
    public function findFirstInAppFrameForBacktrace(array $backtrace) : ?\Sentry\Frame
    {
        $file = \Sentry\Frame::INTERNAL_FRAME_FILENAME;
        $line = 0;
     ...
     */
    public function getCodeLocationForFrame(\Sentry\Frame $frame) : array
    {
