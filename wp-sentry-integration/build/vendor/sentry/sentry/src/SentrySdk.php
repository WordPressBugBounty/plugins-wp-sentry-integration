...
final class SentrySdk
{
    ...
    public static function init() : \Sentry\State\HubInterface
    {
        ...
        self::$runtimeContextManager = new \Sentry\State\RuntimeContextManager(self::$currentHub);
     ...
     * @internal
     */
    public static function getCurrentRuntimeContext() : \Sentry\State\RuntimeContext
    {
    ...
    public static function flush() : void
    {
        ...
        \Sentry\Metrics\TraceMetrics::getInstance()->flush();
        $client = self::getCurrentHub()->getClient();
        if ($client !== null) {
            $client->flush();
        }
    }
    private static function getRuntimeContextManager() : \Sentry\State\RuntimeContextManager
    {
