...
trait TraceHeaderParserTrait
{
    ...
    private static function parseSampleRand(\Sentry\Tracing\DynamicSamplingContext $samplingContext) : ?float
    {
    ...
    private static function shouldContinueTrace(\Sentry\Tracing\DynamicSamplingContext $samplingContext) : bool
    {
        $hub = \Sentry\SentrySdk::getCurrentHub();
        $client = $hub->getClient();
        if ($client === null) {
