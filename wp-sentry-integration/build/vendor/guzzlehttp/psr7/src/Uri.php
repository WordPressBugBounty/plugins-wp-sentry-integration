...
use WPSentry\ScopedVendor\GuzzleHttp\Psr7\Exception\MalformedUriException;
 ...
 */
class Uri implements \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface, \JsonSerializable
{
    /**
     ...
     */
    public static function isDefaultPort(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri) : bool
    {
     ...
     */
    public static function isAbsolute(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri) : bool
    {
     ...
     */
    public static function isNetworkPathReference(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri) : bool
    {
     ...
     * @see https://datatracker.ietf.org/doc/html/rfc3986#section-4.2
     */
    public static function isAbsolutePathReference(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri) : bool
    {
     ...
     * @see https://datatracker.ietf.org/doc/html/rfc3986#section-4.2
     */
    public static function isRelativePathReference(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri) : bool
    {
        return $uri->getScheme() === '' && $uri->getAuthority() === '' && (!isset($uri->getPath()[0]) || $uri->getPath()[0] !== '/');
    }
    /**
     ...
     */
    public static function isSameDocumentReference(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri, ?\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $base = null) : bool
    {
        if ($base !== null) {
     ...
     */
    public static function withoutQueryValue(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri, string $key) : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
     ...
     */
    public static function withQueryValue(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri, string $key, ?string $value) : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
        $result = self::getFilteredQueryString($uri, [$key]);
     ...
     */
    public static function withQueryValues(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri, array $keyValueArray) : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
    ...
    public function withScheme($scheme) : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
    ...
    public function withUserInfo($user, $password = null) : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
    ...
    public function withHost($host) : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
    ...
    public function withPath($path) : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
    ...
    public function withQuery($query) : \WPSentry\ScopedVendor\Psr\Http\Message\UriInterface
    {
     ...
     * @return string[]
     */
    private static function getFilteredQueryString(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri, array $keys) : array
    {
    ...
    private function validateState() : void
    {
        ...
        if ($this->getAuthority() === '') {
            if (0 === \strpos($this->path, '//')) {
                throw new \WPSentry\ScopedVendor\GuzzleHttp\Psr7\Exception\MalformedUriException('The path of a URI without an authority must not start with two slashes "//"');
            }
            if ($this->scheme === '' && \false !== \strpos(\explode('/', $this->path, 2)[0], ':')) {
                throw new \WPSentry\ScopedVendor\GuzzleHttp\Psr7\Exception\MalformedUriException('A relative URI must not have a path beginning with a segment containing a colon');
            }
        }
    }
}
